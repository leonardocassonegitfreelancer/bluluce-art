        ...
        <div className="relative z-10 flex-1 flex flex-col px-7">
          ...
          <div className="hero-ctas flex flex-wrap gap-3 mt-auto pb-12 pt-6">
            <a href={collectionUrl}
              className="inline-flex items-center px-7 py-3.5 font-body text-[0.6rem] tracking-[0.3em] uppercase font-bold transition-all duration-700"
              style={{ background: "#C9A96E", color: "#0E0804" }}>
              {t.cta1}
            </a>
            <a href={aboutUrl}
              className="inline-flex items-center px-7 py-3.5 font-body text-[0.6rem] tracking-[0.3em] uppercase transition-all duration-700"
